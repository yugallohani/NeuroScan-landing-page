              ...
              >
                <div className="px-4 py-4 flex flex-col gap-3">
                  ...
                  <a
                    href="#contact"
                    onClick={() => setMobileOpen(false)}
                    className="text-sm px-4 py-2 rounded-full text-text-bright border border-glow-indigo/30 bg-glow-indigo/5 hover:bg-glow-indigo/10 text-center transition-all duration-300 mt-2"
                  >
                    Request Access
                  </a>
                </div>
